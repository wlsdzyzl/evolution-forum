...
<a href = 'http://120.25.247.220:3000/'><img src='http://120.25.247.220:8080/my_evolution/picture0/article24/3.png' style = "width:2em;height:2em;border-radius:50%"/></a></p>
	...
	<img src="${avatar }" style="width:400px;height:400px;border:3px solid black;margin-left:30px"/>
	<br>
<p class = "shake-little" style="padding:0 30px" ><font>这里是</font><font size=5px>${hostName}</font>的博客！<br><br></p>
<br>
